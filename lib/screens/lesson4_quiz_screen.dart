...
part 'lesson4_quiz_data.dart';
part 'lesson4_quiz_widgets.dart';

const _practiceXpKey = 'lesson_04_practice_reading_measurements_xp';

class Lesson4QuizScreen extends StatefulWidget {
  const Lesson4QuizScreen({super.key});

  @override
  State<Lesson4QuizScreen> createState() => _ScreenState();
}

class _ScreenState extends State<Lesson4QuizScreen>
  ...
  Future<void> _finish() async {
    ...
    await UserStore.mutate((user) {
      ...
      final prevHigh = newTabs['quiz_high_score_3'] ?? 0;
      if (_score > prevHigh) {
        newTabs['quiz_high_score_3'] = _score;
      }
